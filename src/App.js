  ...
  const weddingData = {
    ...
    faqs: [
      { 
        ...
        answer: 'Wir freuen uns über festliche Kleidung in natürlichen, gedeckten Farben – Salbeigrün, Dusty Rose, Creme, Terrakotta. Bitte kein reines Weiß oder Schwarz.' 
      },
      { 
        question: 'Kann ich eine Begleitung mitbringen?', 
        answer: 'Aufgrund der begrenzten Plätze können leider nur die auf der Einladung genannten Personen teilnehmen. Wir hoffen auf euer Verständnis.' 
      },
      { 
        question: 'Sind Kinder willkommen?', 
        answer: 'Ja! Wir feiern gerne mit euren Kleinen. Es gibt einen betreuten Spielbereich im Garten und kindgerechtes Essen.' 
      },
      { 
        question: 'Was ist mit dem Wetter?', 
        answer: 'Die Trauung findet bei jedem Wetter statt – bei Regen weichen wir in das Gewächshaus aus. Bringt sicherheitshalber einen Schirm mit.' 
      },
      { 
        question: 'Darf ich Fotos machen?', 
        answer: 'Bei der Trauung bitten wir um eine "Unplugged Ceremony" – genießt den Moment ohne Handy. Bei der Feier sind Fotos herzlich willkommen!' 
      },
    ],
